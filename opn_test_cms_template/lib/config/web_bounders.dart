...
import '../app/config/theme/color.dart';
...
class LayoutConfig {
  ...
  static LayoutConfig fromWidth(double width) {
    ...
    // 📱 Tablet pequeño en portrait o móvil landscape (600-768px) - Sin contenedor
              ...
              child: Center(
                child: Padding(
                  ...
                  child: Container(
                    ...
                    // MediaQuery ajustado + ScreenUtilInit
                    child: MediaQuery(
