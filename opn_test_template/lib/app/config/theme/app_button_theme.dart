...
abstract class AppButtonTheme {
  ...
  /// Botón relleno (FilledButton) - Tema Claro
  /// - Usa el color primario por defecto
  /// - Border radius consistente de 8px
    ...
    return OutlinedButtonThemeData(
      style: OutlinedButton.styleFrom(
        ...
        side: WidgetStateProperty.all<BorderSide>(
          BorderSide(color: AppColorsLight.primary, width: 1),
        ),
      ),
    );
  }
  ...
  /// Botón relleno (FilledButton) - Tema Oscuro
  /// Mismas características que el tema claro pero con colores adaptados
  static FilledButtonThemeData get filledDark {
    return FilledButtonThemeData(
      style: OutlinedButton.styleFrom(
        ...
        side: WidgetStateProperty.all<BorderSide>(
          BorderSide(color: AppColorsDark.primary, width: 1),
        ),
      ),
    );
  }
