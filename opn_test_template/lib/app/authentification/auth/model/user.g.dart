...
User _$UserFromJson(Map<String, dynamic> json) => User(
      opnIndexData: json['opn_index_data'] == null
          ? null
          : UserOpnIndexCurrent.fromJson(
              json['opn_index_data'] as Map<String, dynamic>),
      ...
      questionGoal: (json['question_goal'] as num?)?.toInt() ?? 300,
      opnIndex: (json['opn_index'] as num?)?.toInt(),
      opnGlobalRank: (json['opn_global_rank'] as num?)?.toInt(),
...
Map<String, dynamic> _$UserToJson(User instance) => <String, dynamic>{
      ...
      'question_goal': instance.questionGoal,
      'opn_index': instance.opnIndex,
      'opn_global_rank': instance.opnGlobalRank,
      ...
      'user_memberships': instance.userMemberships,
      'opn_index_data': instance.opnIndexData,
    };
