...
class _$AuthStateImpl extends _AuthState {
  ...
  @override
  String toString() {
    return 'AuthState(status: $status, user: $user, purchaseInfo: $purchaseInfo, academy: $academy, token: $token, uri: $uri, deviceInfo: $deviceInfo)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, status, user, purchaseInfo, academy, token, uri, deviceInfo);
