...
class AppTexts {
  ...
  static const String appName = 'OPN Test';

  /// Nombre de la organización/empresa
  /// ⚠️ DEPRECADO: Usar FlavorConfig.organizationName
  static const String organizationName = 'OPN Test Template';

  /// URL del sitio web principal
  /// ⚠️ DEPRECADO: Usar FlavorConfig.website
  static const String websiteUrl = 'www.opntest.example';

  /// ⚠️ DEPRECADO: Usar FlavorConfig.domain
  static const String domain = 'opntest.example';
...
class WelcomeTexts {
  ...
  /// ⚠️ DEPRECADO: Usar FlavorConfig
  String get subtitle => 'Prepara tu oposición';
